...
public class BoardController {
	...
	public String boardList(Model model, 
							@PageableDefault(page =  0, size = 7, sort = "openDate", direction = Sort.Direction.ASC) Pageable pageable, 
	...
	public String boardUpdate(@PathVariable("id") Integer id, Board board, MultipartFile file) throws Exception {
		...
		boardTemp.setDirector(board.getDirector());
		boardTemp.setActor(board.getActor());
		boardTemp.setOpenDate(board.getOpenDate());
		boardTemp.setContent(board.getContent());
		
		boardService.fileDelete(id);
